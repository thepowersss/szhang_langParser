...
public class ParserInterpreterTest {
    ...
    public static void testWithFile(Path langPath) {
        try {
            ...
            // parse the code
            Parse parse = ParserInterpreterTest.parser.parse(program);
            ...
            if (parse == null) {
                ...
                actualOutput = ParserInterpreterTest.interpreter.execute(parse);
            }
    ...
    public static void main(String[] args) throws IOException {
        for (String arg : args) {
            ...
            if (Files.isDirectory(path)) {
                ParserInterpreterTest.testWithDirectory(path);
            } else {
                ParserInterpreterTest.testWithFile(path);
            }
        }
    }
}
